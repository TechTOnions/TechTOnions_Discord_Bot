  ...
  return (
    <div className="flex flex-col mt-10 mb-5 ml-8">
      ...
      <div className="grid grid-cols-2 gap-4 mt-8">
        <StatusCardBox heading="Welcome Message" value={welcome} handleChange={useHandleChangeWelcomeMessage} route="welcome-message"/>
        <StatusCardBox heading="Leave Message" value={leave} handleChange={useHandleChangeLeaveMessage} route="leave-message"/>
        <StatusCardBox heading="Level System" value={level} handleChange={useHandleChangeLevelSystem} route="level-setup"/>
        <StatusCardBox heading="Social Notification" value={notification} handleChange={useHandleChangeNotificationSetup} route="notification"/>
        <StatusCardBox heading="Image Channel " value={image} handleChange={useHandleChangeImageStatus} route="Channel-content"/>
        <StatusCardBox heading="Link Channel" value={Link} handleChange={useHandleChangeLinkStatus} route="Channel-content"/>
      </div>
    </div>
  );
}
