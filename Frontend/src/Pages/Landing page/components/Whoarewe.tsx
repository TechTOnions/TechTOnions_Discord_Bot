...
export const Whoarewe=()=>{
    return  <div className="bg-transparent bg-[linear-gradient(164deg,_#070707_21%,_#313131_100%)] rounded-t-[48px] text-white px-16 -mt-8 pt-8 -mb-10 pb-8">
    <div className="flex flex-col items-center justify-center py-6 mx-8 ">
        <div className="py-8 text-6xl shadow-transparent">
            Who We Are
        </div>
