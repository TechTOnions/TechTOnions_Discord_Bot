  ...
  return (
    <div className="flex flex-col items-start justify-center min-w-full mr-1 ">
      <div  className="">
            ...
            <div className={`${pathname == item.route ?' text-white font-medium bg-hoverbg rounded':'text-gray-400'}`}>
              <SubsidebarModule key={key} name={item.name} route={item.route} img={item.img}/>
            </div>
